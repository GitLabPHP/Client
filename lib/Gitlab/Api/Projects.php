...
class Projects extends AbstractApi
{
     ...
     * @return mixed
     */
    public function addBadge($project_id, array $params = [])
    {
     ...
     * @return mixed
     */
    public function updateBadge($project_id, $badge_id, array $params = [])
    {
     ...
     * @return mixed
     */
    public function addDomain($project_id, array $params = [])
    {
        return $this->post($this->getProjectPath($project_id, 'pages/domains'), $params);
    }
     ...
     * @return mixed
     */
    public function updateDomain($project_id, $domain, array $params = [])
    {
        return $this->put($this->getProjectPath($project_id, 'pages/domains/' . $domain), $params);
    }
     ...
     * @param $domain
     */
    public function deleteDomain($project_id, $domain)
    {
        return $this->delete($this->getProjectPath($project_id, 'pages/domains/' . $domain));
    }
}
